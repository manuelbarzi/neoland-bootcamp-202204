describe('FullStackDeveloper', () => {
    it('should build a developer', () => {
        ...
        expect(developer instanceof FullStackDeveloper).toBe(true) //es el contrato está y la línea siguiente
        expect(developer instanceof Developer).toBe(true)   //es una herencia porque es también un trabajador
