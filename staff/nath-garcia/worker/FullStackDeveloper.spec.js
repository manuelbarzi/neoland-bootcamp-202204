describe('Developer', () => {
    ...
    expect(developer instanceof Developer).toBe(true) //es el contrato está y la línea siguiente
    expect(developer instanceof Worker).toBe(true)   //es una herencia porque es también un trabajador
