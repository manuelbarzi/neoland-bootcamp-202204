function Home() {
    Component.call(this, `<div class="Home Container">
        <header class="Home__header Container Container--row Container--spread-sides">
            <button class="Home__home--no-border Home__home">📋</button>
            <div>
                <button class="Buttom Buttom--no-border Home__profile">Profile</button>
                <button class="Buttom Buttom--no-border Home__logout">Logout</button>
            </div> 
        </header>
