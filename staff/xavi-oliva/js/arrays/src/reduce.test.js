describe('reduce', () => {
    ...
    test('extract stats from colors', () => {
        const colors = ['yellow', 'black', 'green', 'yellow', 'blue', 'red', 'red', 'red', 'blue', 'yellow', 'black', 'green', 'yellow', 'yellow', 'blue', 'red', 'red', 'blue', 'yellow', 'black', 'green', 'yellow', 'yellow', 'black', 'green', 'yellow', 'blue', 'red', 'red', 'red', 'blue', 'yellow', 'black', 'green', 'yellow', 'yellow', 'blue', 'red', 'red', 'blue', 'yellow', 'black', 'green', 'yellow']
