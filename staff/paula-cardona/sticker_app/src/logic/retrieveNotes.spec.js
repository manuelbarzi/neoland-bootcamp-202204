describe('retrieveNotes', () => {
    it('returns user notes when user exists and has notes', () => {
        db.users.length = 0
        db.notes.length = 0
...
crea dos nuevas notas

solo me trae las notas de banana
como fragmentar array. solo coge los 3 primero. si hay mas de tres entonces el tercero ya seria undefined
const[note1, note2, note3]= notes    */