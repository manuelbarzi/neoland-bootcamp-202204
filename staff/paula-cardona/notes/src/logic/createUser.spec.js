...
describe ('createUser', () => { //función de createUser
    ...
    it('succeeds on correct credentials', () => {
        return createUser('Peter Pan', 'peterpan', '123123123') //con el return lo que hacemos es que como createUser es asincrono el primer .then quedará esperando ese result y luego se ejecutará
    ...
    it('fails when user already exists', () => { 
        return User.create({ name: 'Wendy Pan', username: 'wendypan', password: '123123123'}) // creo un usuario
            .then(() => createUser('Wendy Pan', 'wendypan', '123123123')) // cuando ya se ha creado, intento crear otro con mi funcion
