...
describe('updateProductQuantityinSchedule', () => {
    ...
    describe('when user already exists', () => {
        ...
        beforeEach(() => {
            ...
            product2 = new Product({ title: 'rustica', type: 1 })
            product3 = new Product({ title: 'molde', type:2 })
        ...
        describe('When item already exists', () => {
            ...
            beforeEach(() => {
                item = new Item ({product: product.id, quantity: 1})
            ...
            it('succeds on update a product with more than 1 quantities', () => {
                ...
                return schedule.save()
                    .then(( ) => {
                        ...
                        return updateProductQuantityinSchedule(user.id, 'monday', product.id)
                    })
                    .then((result) => {                    
        ...
        describe('when item have no quantity', () => {

            let item, item2, item3

            beforeEach(() => {
                item = new Item ({product: product.id, quantity: 0})
                item2 = new Item ({product: product2.id, quantity: 2})
                item3 = new Item ({product: product3.id, quantity: 1})
            ...
            it('succeds on update a product with more than 1 quantities', () => {
                ...
                return schedule.save()
                    ...
                    .then((schedule)=> {
                        ...
                        const found = schedule.monday.some(item => 
                            (item.product.toString() === product.id) && (item.quantity === 1) )
            ...
            it ('fails with wrong user Id', () => {
                ...
                .then (( ) => {
                    ...
                    return updateProductQuantityinSchedule(wrongId, 'monday', product.id)
                })
                .then(() => {
