...
function Viernes (props) {
    ...
    const handleClickBackToThursday = () => {
        props.onClickedBackToThursday()

    }

    const handleClickNexToSaturday = () => {
        props.onClickedNextToSaturday()
    }
    ...
    return isJwtValid (sessionStorage.token) ?
        <div className='Jueves Day'>
            <header className="Header__Day">
                <div>
                    <button className="Button Button__Day__Flecha" onClick={handleClickBackToThursday}>atrás</button>
                        <h1 className= "h1__Day">Viernes</h1>
                    <button className="Button Button__Day__Flecha" onClick ={handleClickNexToSaturday}>siguiente</button>
                </div>
            </header>
            <br>
