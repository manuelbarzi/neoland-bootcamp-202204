...
function Wednesday (props) {
    ...
    const handleClickBackToTuesday = () => {
        props.onClickedBackToTuesday()

    }

    const handleClickNexToThursday = () => {
        props.onClickedNextToThrusday()
    }
    ...
    return isJwtValid (sessionStorage.token) ?
        <div className='Jueves Day'>
            <header className="Header__Day">
                <div>
                    <button className="Button Button__Day__Flecha" onClick={handleClickBackToTuesday}>atrás</button>
                        <h1 className= "h1__Day">Miércoles</h1>
                    <button className="Button Button__Day__Flecha" onClick ={handleClickNexToThursday}>siguiente</button>
                </div>
            </header>
            <br>
