describe('updateNote', () => {
    it('succeeds when user and note already exist', () => {
        ...
        db.users.push(new User('Le Chunga', 'lechunga', 'miguel123'))
        db.users.push(new User('Papa Gayo', 'papagayo', 'miguel123'))

        let note

        db.notes.push(new Note('lechunga', 'Hello, Notes! (1)'))
        db.notes.push(new Note('lechunga', 'Hello, Notes! (2)'))
        db.notes.push(new Note('lechunga', 'Hello, Notes! (3)'))
        db.notes.push(new Note('papagayo', 'Hello, Notes! (4)'))
        db.notes.push(new Note('papagayo', 'Hello, Notes! (5)'))
