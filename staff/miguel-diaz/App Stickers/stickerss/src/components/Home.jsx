...
function Home(props) {
    ...
    return <div className="Home Container">
        <header className="Home__header Container Container--row Container--spread-sides" >
            ...
            <div>
                <button className="Button Button--no-border Home__profile profilebutton" onClick={handleProfileClick}>{name}</button>
                <button className="Button Button--no-border Home__logout logoutbutton" onClick={handleLogoutClick}>Logout</button>
            </div>
        </header>
        ...
        <footer className="Home__footer Container">
            <button className="Home__addSticker btn" onClick={handleAddClick}>New Sticker</button>
        </footer>
    </div>
}
