describe('deleteUser', () => {
    it('succeeds when user exists', () => {
        ...
        deleteUser('chocolater', '123123123', error => {
            ...
            // expect(user.username).toBe('chocolater')
    ...
    it('fails when user does not exist', () => {
        ...
        deleteUser('wrongUsername', '123123123', error => {
    ...
    it('fails with wrong password', () => {
        ...
        db.users.push(new User('Choco Later', 'chocolater', '1234'))
        db.users.push(new User('Pa Tata', 'patata', '1234'))
        db.users.push(new User('To Mate', 'tomate', '1234'))
