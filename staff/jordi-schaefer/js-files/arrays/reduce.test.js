describe('reduce', function () {
    it('sum all numbers of array', function () {
        ...
        const result = reduce(nums, function(acum, elem){
            return acum + elem
        })
    ...
    it('reduce array of chars', function () {
        ...
        const result = reduce(chars, function(acum, elem){
    ...
    it('cart products, calculate total price', function () {
        ...
        const result = reduce(cart, function(acum, elem){
    ...
    it('sum all colours', function () {
        const colors = ['yellow', 'blue', 'red', 'green', 'yellow', 'red', 'blue']
