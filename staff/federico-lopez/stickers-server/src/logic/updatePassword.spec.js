describe('updatePassword', () => {
    it('succeeds when user exists and password is correct', () => {
        ...
        updatePassword('chocolater', '123123123', '234234234', '234234234', error => {
    ...
    it('fails when user exists and password is incorrect', () => {
        ...
        updatePassword('chocolater', '123123123' + '-wrong', '234234234', '234234234', error => {
    ...
    it('fails when user exists and password is same as new password', () => {
        ...
        updatePassword('chocolater', '123123123', '123123123', '123123123', error => {
            expect(error).not.toBeNull()
            expect(error).toBeInstanceOf(Error)
    ...
    it('fails when user exists and new password is not the same as new password repeat', () => {
        ...
        updatePassword('chocolater', '123123123', '234234234', '234234234' + '-wrong', error => {
            expect(error).not.toBeNull()
            expect(error).toBeInstanceOf(Error)
