...
describe('createUser', () => {
    ...
    it('succeeds on correct credentials', () => {
        return createUser('Peter Pan', 'peterpan', '123123123')
            ...
            .then(user => { // compruevo que la funcion a introducido todo los datos bien mirando el la base de datos
    ...
    it('fails when user already exists', () => {
        return User.create({ name: 'Wendy Pan', username: 'wendypan', password: '123123123'})
            ...
            .catch(error => { // el resultado de la funcion 
                ...
                expect(error.message).to.equal(`user with username wendypan already exists`) // devuevle el mensaje 
            })
    })
