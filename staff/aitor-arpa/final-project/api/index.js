...
const {
  ...
  handleClockUserIn,
  handleClockUserOut,
  handleretrieveClockUser,
  handleClockUserJobIn,
  handleClockUserJobOut,
  handleretrieveClockJob,
  handleDeleteJob,
  handleretrieveJobsUser,
  handleRetrieveJobs,
...
(async () => {
  ...
  routes.post("/jobs", jsonBodyParser, handleUpdateJob);
