...
const deleteCommentforNote = require('./deleteCommentforNote')
    ...
    describe('when user already exists', () => {
        ...
        describe('When note exists', () => {
            ...
            describe('When comment already exists', () => {
                ...
                it('succeeds on corret data credentials', () => {
                    ...
                    return deleteCommentforNote(dieghino.id, note.id, comment.id)
                        .then(result => {
            ...
            describe('when comment does not exist', () => {
                ...
                it('fails with no comment', () => {
                    ...
                    return deleteCommentforNote(dieghino.id, note.id, wrongId)
                        .then(() => {
        ...
        describe('When note does not exist', () => {
            ...
            it('fails without note', () => {
                const wrongId = new ObjectId().toString()
                return deleteCommentforNote(dieghino.id, wrongId, wrongId)
                    .then(() => {
                        throw new Error('should not reach this point')
                    })
                    .catch(error => {
