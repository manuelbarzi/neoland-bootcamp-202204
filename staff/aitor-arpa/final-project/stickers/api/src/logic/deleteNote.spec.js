...
describe('deleteNote', () => {
    ...
    describe('when user exists', () => {
        ...
        beforeEach (()=> {
            return User.create({name:'Bart Simpson', username: 'Bart', password: '123123123'})
                .then((user) => {
                    userId = user.id 
            })
        })
        ...
        it ('success with notes and correct credentials', () => {
            ...
            return Note.create({ user: userId,  text: 'jelou'})
                ...
                .then((result)=>{
                    ...
                    return Note.findById(noteId) //la traigo para comprobar si esta borrada o no
                })
                .then((note) => {
    ...
    describe('When user does not exist', () => { 
        ...
        it ('fails with wrong user Id', () => {
            const wrongId = new ObjectId().toString() //creo objetos simulando que son notas y user
