    ...
    it('succeeds on existing user', done => {
        ...
        function churro() {
            ...
            writeFile(`./db/users/${userId}.json`, json, error => { // escribo el nuevo archivo de mi usuario
                ...
                retriveUser(userId, (error, user) => { // uso la funcion para buscar el usuario que acabo de añadir
    ...
    it('Fail with not user', done => {
        ...
        function churro() {
            ...
            writeFile(`./db/users/${userId}.json`, json, error => { // escribo el nuevo archivo de mi usuario
                ...
                retriveUser(createId, (error, user) => { // uso la funcion para buscar el usuario que acabo de añadir
                    expect(error).to.not.be.null // no espero encontrar errotes
