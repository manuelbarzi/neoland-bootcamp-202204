describe('deleteNote', () => {
    it('suceeds when user and note already exist', () => {
        db.users.length = 0
        db.notes.length = 0
    ...
    it('fails when user exist, but note does not', () => {
        db.users.length = 0
        db.notes.length = 0
    ...
    it('fails when user does not exist', () => {
        ...
        db.users.push(new User('Le Chunga', 'lechuga', '1234'))
        db.user.push(new User('Papa Gayo', 'papagayo', '1234'))
