...
describe('updateUser', () => {
    ...
    describe('when user already exists', () => {
        ...
        it('succeeds on correct user data', () =>
            updateUser(user.id, 'Diego Carvalho', 34, 'diego@gmail', '+3412345678')
                .then(result => {
                ...
                .then(user => {
                    ...
                    expect(user.email).to.equal('diego@gmail')
        ...
        it('fails on incorrect user id', () => {
            ...
            return updateUser(wrongId, 'Diego Carvalho', 34, 'diego@gmail', '+3412345678')
                .then(result => {
    ...
    describe('when user does not exist', () => {
        it('fails on unexisting user id', () => {
            ...
            return updateUser(unexistingUserId, 'Diego Carvalho', 34, 'diego@gmail', '+3412345678')
                .then(result => {
                    throw new Error('should not reach this point')
                })
                .catch(error => {
