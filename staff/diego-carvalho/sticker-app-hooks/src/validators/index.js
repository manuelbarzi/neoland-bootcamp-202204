...
function validateNotEmptyOrBlank(string, explain = 'string') {
...
function validateNewName(name, explain = 'name') {
    validateString(name, explain)

    if (name.lenght < 2)
        throw new FormatError(`${explain} the new name is too short`)
}
