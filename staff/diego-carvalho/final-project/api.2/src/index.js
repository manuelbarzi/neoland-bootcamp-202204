...
const {
  ...
  handleToggleUserToEvent } = require('./handlers')

const { connect, disconnect } = require('mongoose')
const { cors } = require('./helpers')

  ; const handleRetrieveTargetedEvent = require('./handlers/handleRetrieveTargetedEvent')
    (async () => {
      ...
      routes.get('/users/:events/:userId', jsonBodyParser, handleRetrieveTargetedEvent)//handleRetrieveTargetedEvent
