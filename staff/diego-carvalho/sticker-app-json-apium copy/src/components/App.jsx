...
function App (){
    ...
    const[feedback, setFeeback] = useState({level: 'error', message: 'Hello World'})
    ...
    const handleFeedback = feeback => setFeeback(feeback)

    const handleFeedbackTimeout = () => setFeeback(null)
